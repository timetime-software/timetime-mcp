  ...
  paths: {
      ...
      post: {
        ...
        responses: {
          ...
          "409": {
            ...
            description:
              "Either someone else already cancelled the booking or a previous request for cancelling the booking by this user was already processed with a different reason.",
          },
        },
        security: [],
      ...
      get: {
        ...
        responses: {
          ...
          "403": {
            ...
            description:
              "The authenticated user can't access to some of the requested calendars.",
          },
        },
      ...
      get: {
        ...
        responses: {
          ...
          "403": {
            ...
            description:
              "The authenticated user can't access this calendar event.",
          },
          "404": {
            content: {
              "application/json": {
      ...
      get: {
        ...
        responses: {
          "200": {
            ...
            description:
              "The list of accessible calendars for the current user.",
          },
        },
      ...
      put: {
        ...
        responses: {
          "204": {
            ...
            description:
              "The calendar has been created or updated successfully.",
          },
          "400": {
            content: {
              "application/json": {
      ...
      post: {
        ...
        responses: {
          "204": {
            ...
            description:
              "Booking has been validated successfully, so TimeTime can proceed.",
          },
          "400": {
            content: {
              "application/json": {
            ...
            description:
              "The booking is not valid for the configured external system.",
          },
        },
        security: [],
        tags: ["booking"],
      ...
      post: {
        ...
        responses: {
          "202": {
            ...
            description:
              "The webhook processing job was scheduled successfully.",
          },
          "204": {
            content: {
              "application/json": {
      ...
      post: {
        ...
        responses: {
          ...
          "403": {
            ...
            description:
              "Current user has no permissions to create a token for the requested user.",
          },
        },
      ...
      get: {
        ...
        responses: {
          ...
          "403": {
            ...
            description:
              "The authenticated user can't access to the requested user.",
          },
          "404": {
            content: {
              "application/json": {
      ...
      delete: {
        ...
        responses: {
          ...
          "403": {
            ...
            description:
              "The authenticated user can't modify this pricing policy",
          },
        },
      ...
      get: {
        ...
        responses: {
          ...
          "403": {
            ...
            description:
              "The authenticated user can't access this pricing policy.",
          },
          "404": {
            content: {
              "application/json": {
      ...
      put: {
        ...
        responses: {
          "204": {
            ...
            description:
              "The pricing policy has been created or updated successfully.",
          },
          "400": {
            content: {
              "application/json": {
          ...
          "403": {
            ...
            description:
              "The authenticated user can't create or update this pricing policy.",
          },
        },
      ...
      put: {
        ...
        responses: {
          "204": {
            ...
            description:
              "Public profile has been created or updated successfully.",
          },
          "400": {
            content: {
              "application/json": {
            ...
            description:
              "There is some problem with the received public profile.",
          },
        },
        tags: ["public-profile"],
      },
    ...
    "/v1/public/tenant": {
      get: {
        ...
        parameters: [
          ...
          {
            description:
              "Optional tenant id to force using that one, instead of checking the referer or the user's tenant.",
            in: "query",
            name: "id",
            required: false,
            schema: {
    ...
    "/v1/users": {
      ...
      post: {
        ...
        summary:
          "Creates a user in the tenant of the user making the request..",
        tags: ["user"],
      },
    },
    "/v1/users/{id}": {
      ...
      delete: {
        ...
        responses: {
          ...
          "403": {
            ...
            description:
              "The authenticated user can't has no permissions over this resource.",
          },
        },
      ...
      put: {
        ...
        responses: {
          "204": {
            ...
            description:
              "The workflow has been created or updated successfully.",
          },
          "400": {
            content: {
              "application/json": {
  ...
  components: {
    schemas: {
          ...
          },
          {
            ...
            properties: {
              after: {
                type: "string",
                description:
                  "How after confirming the booking the workflow should be executed in ISO8601 duration format. For executing the workflow 15 minutes after confirming, PT15M is a valid value. If we want the workflow to be executed straightaway, null is a valid value.",
              },
            },
          },
        ],
          ...
          },
          {
            ...
            properties: {
              before: {
                ...
                format: "duration",
                description:
                  "How much before the actual event the workflow needs to be triggered in ISO8601 duration format.For executing the workflow 15 minutes before the event, PT15M is a valid value.",
              },
            },
          },
        ],
      ...
      BookingWebhookNotification: {
        ...
        properties: {
          enabled: {
            type: "boolean",
            description:
              "Flag indicating if webhook notifications are enabled. Webhook config will be inherited from the tenant config (only available for enterprise customers).",
          },
        },
        required: ["enabled"],
      },
      BookingWhatsappNotification: {
        ...
        properties: {
          additionalInformation: {
            type: "string",
            description:
              "Additional information to be appended to the whatsapp message.",
            maxLength: 1024,
            minLength: 0,
          },
          enabled: {
            type: "boolean",
            description:
              "Flag indicating if whatsapp notifications are enabled.",
          },
        },
        required: ["enabled"],
      },
      ...
      CalendarEvent: {
        ...
        properties: {
          ...
          interval: {
            ...
            description:
              "Interval indicating when the event is happening. It's optional, an event without an interval is a valid event in TimeTime. It can be useful to keep track of pending tasks that have not a date in the moment of its creation.",
          },
          locations: {
            type: "array",
            description:
      ...
      CalendarEventAttachment: {
        ...
        properties: {
          mimeType: {
            type: "string",
            description:
              "Attachment MIME type as defined in RFC 2045 and 2046. Example 'image/jpeg'. It'll be helpful for the frontend apps to show images for example.",
            example: "image/jpeg",
            maxLength: 64,
            minLength: 0,
          },
          url: {
            ...
            format: "uri",
            description:
              "URI of the attachment. The TimeTime server won't try to fetch it.",
          },
        },
        required: ["url"],
      },
      CalendarEventAttendee: {
        ...
        properties: {
          ...
          phone: {
            type: "string",
            description:
              "The attendee's phone number, if available, in e164 format.",
            maxLength: 36,
            minLength: 0,
          },
          status: {
      ...
      CalendarEventDiff: {
        type: "object",
        description:
          "This is kind of syntax sugar to improve the Developer Experience for the webhook receiver. Some of the changes in the Calendar Event receive an special treatment and have a name and additional information.\nNot all Calendar Event changes have an specific 'diff' value.",
        discriminator: {
          propertyName: "type",
        },
        properties: {
      ...
      CalendarEventLocation: {
        ...
        properties: {
          text: {
            type: "string",
            description:
              "Event location in a free text form. It won't be processed by the server.",
            maxLength: 4096,
            minLength: 0,
          },
        },
      ...
      CreateLoginTokenRequest: {
        ...
        properties: {
          externalId: {
            type: "string",
            description:
              "Id on an external system. Typically the user id on the tenant service side.",
          },
        },
        required: ["externalId"],
      },
          ...
          },
          {
            ...
            properties: {
              additionalInformation: {
                type: "string",
                description:
                  "Additional information to be appended to the notification.",
                maxLength: 1024,
                minLength: 0,
              },
              email: {
          ...
          },
          {
            ...
            properties: {
              location: {
                type: "string",
                description:
                  "The free location string. It'll be used in communications such as SMS reminders, emails...",
              },
            },
          },
        ],
          ...
          },
          {
            ...
            properties: {
              amount: {
                type: "string",
                description:
                  "Amount expressed in an string to avoid precisions loses.",
                examples: ["12.45", "20"],
              },
            },
          },
          ...
          },
          {
            ...
            properties: {
              addAttendees: {
                type: "boolean",
                description:
                  "Whether to add the attendees to the calendar or not. If they are added, they might get notifications, based on the `guestNotificationsMode` field.",
              },
              addOrganizerAsAttendee: {
                type: "boolean",
                description:
                  "Whether to add the organizer (the owner of the calendar) as an attendee or not. Not adding it is useful when the organizer sets up meetings for other people. ",
              },
              calendarId: {
                type: "string",
                description:
                  "The google calendar id in which events will be inserted. The id is not the raw google calendar id but the timetime version of it. It can be fetched with the user info.",
              },
              colorId: {
                type: "string",
              },
              ...
              extraEmailAttendees: {
                type: "array",
                description:
                  "A fixed list of additional attendees that must be always added to the event.",
                items: {
                  type: "string",
                },
                uniqueItems: true,
              ...
              guestNotificationsMode: {
                type: "string",
                description:
                  "Configures how google will behave, how they will send notifications about the creation of the new event. \n * `ALL` - Notifications are sent to all guests\n * `EXTERNAL_ONLY` - Notifications are sent to non-Google Calendar guests only\n * `NONE` - No notifications are sent \n\nNote that some emails might still be sent by google regardless of this configuration. ",
              ...
              overlapMode: {
                type: "string",
                description:
                  "Defines how TimeTime will behave when a google calendar event is already in place for the same TimeTime resource or event type. An overlap is possible if maxConcurrentBookings has been set to number higher than 1 or if the event type is not configured to check the availability in the target calendar.\n * `NEW_EVENT` - A new event will be inserted without taking in consideration what's in the calendar.\n * `UPDATE_ATTENDEES` - The previous inserted event is reused, and TimeTime will sync the attendees accordingly",
          ...
          },
          {
            ...
            properties: {
              calendarId: {
                type: "string",
                description:
                  "The google calendar id in which the OOO will be inserted. The id is not the raw google calendar id but the timetime version of it. It can be fetched with the user info.",
              },
            },
          },
        ],
          ...
          },
          {
            ...
            properties: {
              timeout: {
                ...
                format: "duration",
                description:
                  "The timeout for the hold. If the timeout is reached without confirming the hold, the booking will be automatically canceled.",
              },
            },
          },
        ],
      ...
      LoginToken: {
        ...
        properties: {
          token: {
            type: "string",
            description:
              "The temporary token that can be used for login the user.",
          },
        },
        required: ["token"],
      },
        ...
        discriminator: {
          mapping: {
            ...
            PricingPolicyOwnerUser:
              "#/components/schemas/PricingPolicyOwnerUser",
          },
          propertyName: "type",
        },
        properties: {
      ...
      PutEventTypeModel: {
        ...
        properties: {
          ...
          busyIntervals: {
            type: "array",
            description:
              "Set of intervals during which the event type is busy.",
            items: {
              $ref: "#/components/schemas/InstantInterval",
            },
            uniqueItems: true,
          ...
          enabled: {
            type: "boolean",
            description:
              "When set to false, the event type will never be available.",
          },
          hosts: {
            type: "array",
          ...
          userId: {
            ...
            format: "uuid",
            description:
              "User id of the owner, if not provided, the id of the current user is assumed.",
          },
          workflows: {
            type: "array",
      ...
      PutPricingPolicyRequest: {
        ...
        properties: {
          ...
          owner: {
            description:
              "Owner of the pricing policy. If not specified, the user's id will be used.",
            oneOf: [
              {
                $ref: "#/components/schemas/PricingPolicyOwnerOrg",
              },
      ...
      ResourceCollaborator: {
        type: "object",
        description:
          "Collaborators for the resource. Once a collaborator is added, that means the they can see and configure this resource as needed for their services.",
        discriminator: {
          propertyName: "type",
        },
        properties: {
          ...
          },
          {
            ...
            properties: {
              before: {
                ...
                format: "duration",
                description:
                  "How much before the start of the event the notification needs to be triggered, in ISO8601 duration format.For sending the notification 15 minutes before the event, PT15M is a valid value.",
                examples: ["PT1H", "PT30M"],
              },
              id: {
                type: "string",
              ...
              phone: {
                type: "string",
                description:
                  "The phone number of the receiver, in e164 format.",
              },
            },
          },
        ],
          ...
          },
          {
            ...
            properties: {
              date: {
                ...
                format: "date",
                description:
                  "The start date of the invitation, ISO 8601 format, YYYY-MM-DD",
              },
              timeZone: {
                type: "string",
                description:
      ...
      WebhookDeliveryConfig: {
        ...
        properties: {
          password: {
            type: "string",
            description:
              "A password to be used when calling the webhook URL. It'll be sent as the value of the 'X-TT-Webhook-Password' header.",
            maxLength: 2048,
            minLength: 0,
          },
          url: {
      ...
      ZonedDateTime: {
        type: "object",
        description:
          "The time zone parameter is optional, the dateTime must include the offset.",
        properties: {
          dateTime: {
            type: "string",
            format: "date-time",
            description:
              "The time, as a combined date-time value, following the ISO 8601 standard.",
          },
          timeZone: {
            type: "string",
            description:
